...
public static partial class DotNetBuildDiagnosticParser
{
    [GeneratedRegex(@"^(?<loc>.+\(\d+,\s*\d+\))\s*:\s*(?<sev>error|warning)\s+(?<code>\S+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex MsBuildFileLineDiagnostic();

    [GeneratedRegex(@"^(?<loc>.+?)\s*:\s*(?<sev>error|warning)\s+(?<code>MSB\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex MsBuildProjectLineDiagnostic();

    [GeneratedRegex(@"^(?<loc>.+?)\s*:\s*(?<sev>error|warning)\s+(?<code>NU\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex NuGetDiagnosticWithPath();

    [GeneratedRegex(@"^(?<sev>error|warning)\s+(?<code>NU\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex NuGetDiagnosticBare();

    [GeneratedRegex(@"^(?:\d+>\s*)?:\s*(?<sev>error|warning)\s+(?<code>NU\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex NuGetDiagnosticColonPrefixed();

    [GeneratedRegex(@"^(?:\d+>\s*)?:\s*(?<sev>error|warning)\s+(?<code>MSB\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex MsBuildDiagnosticColonPrefixed();

    [GeneratedRegex(@"^(?<sev>error|warning)\s+(?<code>MSB\d+)\s*:\s*(?<msg>.*)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex MsBuildDiagnosticBare();

    [GeneratedRegex(@"(?<sev>error|warning)\s+(?<code>NU\d+)\s*:\s*(?<msg>.+)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex NuGetDiagnosticEmbedded();

    [GeneratedRegex(@"(?<sev>error|warning)\s+(?<code>MSB\d+)\s*:\s*(?<msg>.+)$", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant)]
    private static partial Regex MsBuildDiagnosticEmbedded();
